...
/**
 * Servlet implementation class CurrentBiddingAdminServlet
 */
@WebServlet("/CurrentBiddingAdminServlet")
public class CurrentBiddingAdminServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			rst=st.executeQuery("select * from bidding_details");
			request.setAttribute("resultset",rst);
			System.out.println("running");
			RequestDispatcher rd=request.getRequestDispatcher("/CurrentBiddingAdmin.jsp");

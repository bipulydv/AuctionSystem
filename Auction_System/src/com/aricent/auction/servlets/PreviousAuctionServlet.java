...
/**
 * Servlet implementation class PreviousAuctionServlet
 */
@WebServlet("/PreviousAuctionServlet")
public class PreviousAuctionServlet extends HttpServlet {
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			RequestDispatcher rd=request.getRequestDispatcher("/PreviousAuction.jsp");

...
//ResultSet rs1=(ResultSet)request.getAttribute("price_bid");
while (rs.next()) {
 String i=(String)session.getAttribute("i_value");%>
	<p class="details">
	<% 
...
if(d==0.0)
	...
	out.println("current maximum bid price: "+request.getAttribute("price"));

...
<p class="details">Different mobiles available for auction</p>
...
while (rs.next()) {
 ...
 int pid=rs.getInt("product_id");
	...
	out.println(rs.getFloat("initial_bid"));%>
        ...
        String str="D:\\gur44297\\AuctionSystem\\AuctionSystem\\WebContent\\MobileDetails"+i+".jpg";
 ...
 out.println("<img src='MobileDetails"+i+".jpg'  style='width:200px;height:180px;'>");
   ...
   %>
	...
	<form action="BiddingMobileServlet" method="get">
